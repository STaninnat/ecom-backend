...
func TestHandlerAddItemToUserCart_ServiceError(t *testing.T) {
	...
	mockLogger.On("LogHandlerError", mock.Anything, "add_item_to_cart", "product_not_found", "not found", mock.Anything, mock.Anything, mock.Anything).Return()
...
func TestHandlerAddItemToGuestCart_MissingSessionID(t *testing.T) {
	...
	mockLogger.On("LogHandlerError", mock.Anything, "add_item_guest_cart", "missing id", "Missing session ID", mock.Anything, mock.Anything, mock.Anything).Return()
...
func TestHandlerAddItemToGuestCart_ServiceError(t *testing.T) {
	...
	mockLogger.On("LogHandlerError", mock.Anything, "add_item_guest_cart", "cart_full", "full", mock.Anything, mock.Anything, mock.Anything).Return()
